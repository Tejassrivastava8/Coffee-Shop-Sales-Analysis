...
## Features Used
1. **MS Excel:** The foundation for data organization and manipulation.
2. **Power Query:** Ensures clean and transformed data.
3. **Power Pivot:** Enables data modeling and measure calculations.
4. **Pivot Tables:** Summarizes and filters top performers.
5. **Charts & Graphs:** Visualizes trends.
...
_Note: This analysis was conducted as part of a project and is for educational purposes only._
